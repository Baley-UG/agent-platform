...
def test_app_routes_mounted():
    ...
    expected_prefixes = {
        ...
        "/api/v1/projects/{project_id}/remakes",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/plan",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/approve-plan",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/shots/{shot_id}/retry",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/shots/{shot_id}/reject",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/approve-final",
        "/api/v1/projects/{project_id}/remakes/{remake_id}/archive",
