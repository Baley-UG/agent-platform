...
Mirrors `ig_scraper`: same shared Postgres instance, but tables for this
service all live in the `content_pipeline` schema (set per-table on the
SQLModel definitions). Two engines: primary for writes, optional read
